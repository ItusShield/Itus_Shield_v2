...
Category: Network
Repository: base
Title: Complete open source PBX, v16.3.0
Maintainer: Jiri Slachta <jiri@slachta.eu>
Source: asterisk-16.3.0.tar.gz
License: GPL-2.0
...
LicenseFiles: COPYING LICENSE
Type: ipkg
Description: Linux telephony API support.
http://www.asterisk.org/
Jiri Slachta <jiri@slachta.eu>
@@
...
Submenu: Telephony
Version: 16.3.0-2
Depends: +libc +GCC_LIBSSP:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread asterisk16 +PACKAGE_asterisk16-pbx-lua:liblua
Conflicts: 
Menu-Depends: 
Provides: 
Section: net
...
Submenu: Telephony
Version: 16.3.0-2
Depends: +libc +GCC_LIBSSP:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread asterisk16 +PACKAGE_asterisk16-res-calendar-caldav:asterisk16-res-calendar +PACKAGE_asterisk16-res-calendar-caldav:libical +PACKAGE_asterisk16-res-calendar-caldav:libneon +PACKAGE_asterisk16-res-calendar-caldav:libxml2
Conflicts: 
Menu-Depends: 
Provides: 
Section: net
